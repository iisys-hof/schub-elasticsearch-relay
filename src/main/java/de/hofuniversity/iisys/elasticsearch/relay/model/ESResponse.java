...
public class ESResponse
{
     ...
     * Elasticsearch. Collects all result objects and stores the number of
     * total hits and shards.
     * 
     * @param body result object sent by Elasticsearch
     * @throws Exception if disassembly fails
     */
    public ESResponse(JSONObject body) throws Exception
    {
        ...
        if(body != null)
        {
            ...
            if(hitsObj != null
                && hitsObj.optJSONArray(ESConstants.R_HITS) != null)
            {
            ...
            {
                fShards = body.getJSONObject(ESConstants.R_SHARDS)
                    .getInt(ESConstants.R_SHARDS_TOT);
            }
        }
    }
