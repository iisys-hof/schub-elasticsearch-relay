...
/**
 * Filter excluding indices and types from the query result.
 * Adjusts query body and query path.
 */
public class BlacklistFilter implements IFilter
{
     ...
     * 
     * @param indices indices to filter out
     * @param types result types to filter out
     */
