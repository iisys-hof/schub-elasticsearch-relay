...
/**
 * Set of permissions of a user and further information including their
 * liferay ID, liferay groups, liferay roles and nuxeo groups.
 */
public class UserPermSet
{
    ...
    /**
     * @param name ID of the user this set is for
     */
