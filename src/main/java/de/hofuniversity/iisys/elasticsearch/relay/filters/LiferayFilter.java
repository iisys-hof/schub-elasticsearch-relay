...
/**
 * Liferay filter filtering its unspecific entries by their owners' Liferay
 * user ID and roles.
 * Filtering for groups is not yet implemented.
 */
public class LiferayFilter implements IFilter
{
    ...
    /**
     * @param types liferay result types
     * @param passRoles generic roles every user is a member of
     */
        ...
        List<String> indices, List<String> types)
    {
        ...
        // TODO: possibly filter all internal types that are not supposed to be found
