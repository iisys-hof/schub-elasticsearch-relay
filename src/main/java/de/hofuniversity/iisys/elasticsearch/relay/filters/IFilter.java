...
public interface IFilter
{
     ...
     * and returns a query object with fewer or additional statements.
     * The given indices and types may contain "*" or "_all" or be empty,
     * meaning that all indices or types are to be queried.
     * 
     * @param perms permissions and other info for the current user
     * @param query query to an Elasticsearch instance
     * @param indices indices that are being queried
     * @param types types that are being queried
